...
$(document).ready(function() {
	...
	$('.my-navbar > .my-navlinks-container > .my-navelement > .my-navlink > a[href="'+pathname+'"]').parent().addClass('active');
})

$('.my-navlink').on('click',function(){
  //Remove any previous active classes
  $('.my-navlink').removeClass('active');
